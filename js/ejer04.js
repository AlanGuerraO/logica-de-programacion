...
console.log(sentence.replace("es", "is")); // Reemplaza el texto especificado por otro texto, solo la primera ocurrencia
...
console.log(sentence.slice(1, 3)); // Devuelve una nueva cadena que contiene las letras del texto original desde la posición especificada hasta la posición especificada menos uno (- 1) Permite valores negativos

console.log(sentence.split(" es ")); // Divide la cadena en una lista de cadenas, separando cada una por el texto especificado

console.log(sentence.substring(1, 3)); // Devuelve una nueva cadena que contiene las letras del texto original desde la posición especificada hasta la posición especificada menos uno (- 1). No permite valores negativos
